...
const uint8_t digital_pin_to_port_PGM[] = {
    ...
    _IOPORT_PC, // 3 = RC9 (INT1)
    _IOPORT_PC, // 4 = RC6 (INT2)
    _IOPORT_PA, // 5 = RA1 (INT3)
    _IOPORT_PC, // 6 = RC5 (INT4)
    _IOPORT_PA, // 7 = RA9
    ...
    _IOPORT_PB, // 21 / PROG = RB13
    _IOPORT_PA, // 22 / L = RA10
    _IOPORT_PB, // 23 / TX = RB0
    _IOPORT_PB, // 24 / RX = RB1

    _IOPORT_PB, // 25 / MISO = RB11
    _IOPORT_PB, // 26 / SCK = RB14
    _IOPORT_PC, // 27 / MOSI = RC8
...
const uint8_t digital_pin_to_pps_out_PGM[] = {
    ...
    _PPS_OUT(_PPS_RPC9R), // 3 = RC9 (INT1)
    _PPS_OUT(_PPS_RPC6R), // 4 = RC6 (INT2)
    _PPS_OUT(_PPS_RPA1R), // 5 = RA1 (INT3)
    _PPS_OUT(_PPS_RPC5R), // 6 = RC5 (INT4)
    ...
    _PPS_OUT(_PPS_RPB13R), // PROG = RB13
    NOT_PPS_PIN,           // L = RA10
    NOT_PPS_PIN,           // TX = RB0
    _PPS_OUT(_PPS_RPB1R),  // RX = RB1

    _PPS_OUT(_PPS_RPB11R), // MISO = RB11
    NOT_PPS_PIN,           // SCK = RC7
    _PPS_OUT(_PPS_RPC8R),  // MOSI = RC8
...
const uint8_t digital_pin_to_pps_in_PGM[] = {
    ...
    NOT_PPS_PIN,        // 2 = RB7 (INT0)
    _PPS_IN(_PPS_RPC9), // 3 = RC9 (INT1)
    _PPS_IN(_PPS_RPC6), // 4 = RC6 (INT2)
    _PPS_IN(_PPS_RPA1), // 5 = RA1 (INT3)
    _PPS_IN(_PPS_RPC5), // 6 = RC5 (INT4)
    ...
    _PPS_IN(_PPS_RPB13), // PROG = RB13
    NOT_PPS_PIN,         // L = RA10
    NOT_PPS_PIN,         // TX = RB0
    _PPS_IN(_PPS_RPB1),  // RX = RB1

    _PPS_IN(_PPS_RPB11), // MISO = RB11
    NOT_PPS_PIN,         // SCK = RB14
